	...
	<tr>
		<td align="left" style="padding-top: 25px;">
			...
			<p style="font-size: 12px; font-weight: 400; color: #262626; margin: 0; padding: 0; line-height: 16px; mso-line-height-alt: 16px">
				Dive deeper on <a href="https://vrts.app" style="font-size: 12px; font-weight: 400; color: #1954ed; text-align: left; text-decoration-line: underline; text-decoration: underline">vrts.app</a> and our guide “<a href="https://bleech.de/en/blog/how-does-visual-regression-testing-work/" style="font-size: 12px; font-weight: 400; color: #1954ed; text-align: left; text-decoration-line: underline; text-decoration: underline">How does visual regression testing work?</a>”</span>
			</p>
		</td>
	</tr>
	<tr>
				...
				<tr>
					...
					<td valign="middle" style="padding-left: 4px">
						<p style="color: #262626; margin: 0; padding: 0; font-size: 12px; line-height: 20px; mso-line-height-alt: normal">
							<strong>VRTs Plugin</strong> on <a href="https://vrts.app" style="font-size: 12px; font-weight: 400; color: #1954ed; text-decoration-line: underline; text-decoration: underline">[vrts.app]</a>
						</p>
					</td>
				</tr>
			</table>
