...
<vrts-comparisons class="vrts-comparisons postbox">
	...
	<div class="vrts-comparisons__content-container">
		...
		<button type="button" class="vrts-comparisons__jump" data-vrts-comparisons-jump data-vrts-visible="false" title="<?php esc_attr_e( 'Scroll to changes', 'visual-regression-tests' ); ?>" aria-label="<?php esc_attr_e( 'Scroll to changes', 'visual-regression-tests' ); ?>">
