									...
									<div id="misc-publishing-actions">
										...
										<div class="misc-pub-section">
											...
											<strong>
												...
												<?php echo esc_html( sprintf( _n( '%s element', '%s pixels', esc_html( intval( $data['alert']->differences / 4 ) ), 'visual-regression-tests' ), esc_html( intval( $data['alert']->differences / 4 ) ) ) ); ?>
											</strong>
										</div>
